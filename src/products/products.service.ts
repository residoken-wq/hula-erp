...
export class ProductsService {
    ...
    async findAll() {
        const products = await this.productRepo.find({
            select: ['id', 'sku', 'name', 'category_id', 'product_type', 'cost_price', 'base_price', 'quantity_in_stock', 'booking_stock', 'profit_margin', 'is_active', 'unit', 'customer_description', 'processing_description', 'vat_description', 'image_url', 'show_on_website', 'contact_for_price', 'website_price', 'website_sale_price', 'website_order', 'website_display_name', 'tags'],
            order: { id: 'DESC' },
