                ...
                <div className="flex-1 overflow-y-auto overscroll-contain">
                    {items.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full px-6 py-12">
                            ...
                            <button
                                onClick={handleClose}
                                className="px-6 py-3 bg-primary-600 text-white font-semibold rounded-xl hover:bg-primary-700 transition-all active:scale-95"
                            >
                                Khám phá sản phẩm
                            </button>
                        </div>
                ...
                {items.length > 0 && (
                    <div className="border-t border-gray-100 bg-white p-5 space-y-4 safe-area-inset-bottom">
                        ...
                        <div className="flex gap-3">
                            <button
                                onClick={handleClose}
                                className="flex-1 py-3.5 px-4 border-2 border-gray-200 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition-all active:scale-[0.98]"
                            >
                                Mua thêm
                            </button>
                            <Link
                                href="/checkout"
                                onClick={handleClose}
                                className="flex-[2] py-3.5 px-4 bg-gradient-to-r from-primary-600 to-primary-500 text-white font-semibold text-center rounded-xl hover:shadow-lg hover:shadow-primary-500/30 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                            >
                                Thanh toán
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
